...
# Lab06:
def save_game(winner: str, hero_name="", num_stars=0):
    with open('save.txt', 'a') as file:
        # Q3
        if winner.lower() == "hero":
            file.write(f"Hero {hero_name} has killed the Monster and gained {num_stars} stars.")
        # Q4
        elif winner.lower() == "monster":
...
# Lab 06 - Q5b
def adjust_combat_strength(last_game, comat_strength, m_comat_strength):
    if last_game:
